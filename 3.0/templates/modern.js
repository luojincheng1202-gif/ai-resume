...
export function renderModernTemplate(resumeData, lang, getData) {
  lang = lang || 'cn'
...
a { color: #374151; text-decoration: none; border-bottom: 1px solid #d1d5db; }
a:hover { border-bottom-color: #1c1c1c; }
.personal-header {
  padding-left: 14pt;
...
.name {
  font-size: ${isCn ? '20pt' : '21pt'};
  font-weight: 700;
  letter-spacing: ${isCn ? '1px' : '0'};
  color: #1c1c1c;
  line-height: 1.2;
}
.job-title {
...
.contact-line a { border-bottom: none; color: #6b7280; }
.summary {
  font-size: 9.5pt;
  color: #374151;
  margin-top: 6pt;
...
.section-title {
  ...
  letter-spacing: ${isCn ? '1.5px' : '1.2px'};
  color: #6b7280;
  padding-bottom: 3pt;
...
.entry-title { font-weight: 600; font-size: 10.5pt; flex: 1; color: #111827; }
.entry-date { color: #9ca3af; font-size: 9pt; white-space: nowrap; margin-left: 8pt; flex-shrink: 0; }
.entry-subtitle { color: #6b7280; font-size: 9.5pt; margin-top: 1.5pt; }
.entry-extra { color: #9ca3af; font-size: 9pt; margin-top: 2pt; }
ul { margin: 4pt 0 0 14pt; padding: 0; }
li { margin-bottom: 2pt; font-size: 9.5pt; color: #374151; }
.skill-row { display: flex; align-items: baseline; margin-bottom: 3.5pt; font-size: 9.5pt; }
.skill-entry { display: flex; align-items: flex-start; margin-bottom: 4pt; font-size: 9.5pt; }
.skill-label { font-weight: 600; min-width: 78pt; flex-shrink: 0; color: #374151; }
.skill-bullets { margin: 0; padding-left: 14pt; list-style: disc; }
.skill-bullets li { margin-bottom: 1.5pt; font-size: 9.5pt; }
.tech-stack { color: #6b7280; font-size: 9pt; }
.proj-link { font-size: 9pt; color: #9ca3af; border-bottom: none; }
