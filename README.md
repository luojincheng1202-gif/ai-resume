...
**Netlify Drop：**
将 `3.0/` 文件夹整体拖拽至 [app.netlify.com/drop](https://app.netlify.com/drop)，5 秒内上线。

**Cloudflare Pages / Vercel / 任意静态托管：**
无需构建命令，直接发布即可。
...
Visit the deployed URL directly — no setup needed.
...
**Netlify Drop:**
Drag the `3.0/` folder to [app.netlify.com/drop](https://app.netlify.com/drop) — live in 5 seconds.

**Cloudflare Pages / Vercel / Any static host:**
No build command needed. Just publish the files directly.
